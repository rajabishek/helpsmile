...
class DonorsController extends Controller {
     ...
     * @return void
     */
    public function __construct(DonorRepositoryInterface $donors, UserRepositoryInterface $users)
    {
        $this->donors = $donors;
        $this->users = $users;
    }
	...
	public function index($domain, Request $request)
	{
        ...
        if($term)
        {
        	...
        	return view('teamleader.donors.index',compact('domain','donors','message','term'));
        }
        else{
            ...
            return view('teamleader.donors.index',compact('domain','donors','message'));
        }
	}
	...
	public function show($domain,$id)
	{
        try
        {
            ...
            return view('teamleader.donors.show',compact('domain','donor'));
        }
        catch(DonorNotFoundException $e)
        {
            $backLink = route('teamleader.donors.index',$domain);
    ...
    { 
        ...
        return redirect()->route('teamleader.donors.index',$domain);
    }
}
