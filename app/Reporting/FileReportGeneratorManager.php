<?php namespace Helpsmile\Reporting;

use Illuminate\Contracts\Foundation\Application;
use Helpsmile\Reporting\Contracts\Factory as FactoryContract;
use Helpsmile\Reporting\Contracts\FileReportGenerator;
...
class FileReportGeneratorManager implements FactoryContract
{
    ...
    {
        return $this->app->make('Helpsmile\Reporting\ExcelReportGenerator');
    }
}