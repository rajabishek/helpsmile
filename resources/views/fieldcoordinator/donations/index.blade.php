    ...
    <main id="main-container">
		...
		<div class="content bg-gray-lighter">
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">Unassigned Donations</h1>
                </div>
						    ...
						    <div class="block-content">
						        <div class="row">
									<div class="col-md-8 col-xs-12">
										...
										{!! Form::open(['route' => ['fieldcoordinator.donations.index',$domain], 'method' => 'GET']) !!}
					...
					@else
						<div class="row">
							<div class="col-md-8 col-xs-12">
		                        ...
		                        <a href="{{route('fieldcoordinator.donations.index',$domain)}}" class="btn btn-warning">Go back <i class="glyphicon glyphicon-arrow-left"></i></a>
							</div>
						</div>
					@endif
				</div>
...
<script>
	$(function () {
		App.initHelpers(['slimscroll','select2']);
