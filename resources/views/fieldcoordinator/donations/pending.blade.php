						    ...
						    <div class="block-content">
						        <div class="row">
									<div class="col-md-8 col-xs-12">
										...
										{!! Form::open(['route' => ['fieldcoordinator.donations.getPending',$domain], 'method' => 'GET']) !!}
									...
									<div class="col-md-4 col-xs-12">
										<div class="col-xs-12">
											<h4 class="font-w300 push">Filter by fieldexecutives</h4>
										</div>
										{!! Form::open(['route' => ['fieldcoordinator.donations.getPending',$domain], 'method' => 'GET']) !!}
									    	<div class="form-group">
		                                        <div class="col-xs-12">
		                                            <div class="form-material">
		                                                {!! Form::select('fieldexecutive',$fieldexecutivesList,Request::get('fieldexecutive'),['class' => 'form-control js-select2 filter-autosubmitform','style' => 'width: 100%;']) !!}
		                                            </div>
		                                        </div>
		                                    </div>
										{!! Form::close() !!}
										...
										<div class="table-responsive">
											<table class="table table-bordered">
									            <thead>
									                <tr>
									                    <th>Name</th>
									                 	<th class="hidden-xs">Field Executive</th>
									            ...
									            <tbody>
									                @foreach($donations as $donation)
														<tr>
														    ...
														    <td class="hidden-xs">{{ $donation->fieldexecutive->fullname }}</td>
								...
								<div class="text-center">{!! $donations->appends(Request::only('q','fieldexecutive'))->render() !!}</div>
						    </div>
						</div>
					...
					@else
						<div class="row">
							<div class="col-md-8 col-xs-12">
		                        ...
		                        <a href="{{route('fieldcoordinator.donations.getPending',$domain)}}" class="btn btn-warning">Go back <i class="glyphicon glyphicon-arrow-left"></i></a>
							</div>
						</div>
					@endif
				</div>
