...
@section('title', 'Donated Donations')
    ...
    <main id="main-container">
		...
		<div class="content bg-gray-lighter">
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">Donated Donations</h1>
                </div>
						    ...
						    <div class="block-content">
						        <div class="row">
									<div class="col-md-8 col-xs-12">
										...
										{!! Form::open(['route' => ['fieldcoordinator.donations.getDonated',$domain], 'method' => 'GET']) !!}
										...
										<div class="table-responsive">
											<table class="table table-bordered">
									            <thead>
									                <tr>
									                    <th>Name</th>
									                 	<th class="hidden-xs">Donated Amount</th>
									            ...
									            <tbody>
									                @foreach($donations as $donation)
														<tr>
														    ...
														    <td class="hidden-xs">{{ $donation->donated_amount }}</td>
					...
					@else
						<div class="row">
							<div class="col-md-8 col-xs-12">
		                        ...
		                        <a href="{{route('fieldcoordinator.donations.getDonated',$domain)}}" class="btn btn-warning">Go back <i class="glyphicon glyphicon-arrow-left"></i></a>
							</div>
						</div>
					@endif
				</div>
