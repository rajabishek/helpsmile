                ...
                <div class="modal-dialog modal-dialog-popout">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            {!! Form::open(['route' => ['fieldcoordinator.donors.destroy',$domain,$donor->id],'method' => 'DELETE']) !!}
                    ...
                    <div class="modal-content">
                        <div class="block block-themed block-transparent remove-margin-b" id="change-donor-details-block">
                            ...
                            <div class="block-content">
                                ...
                                {!! Form::model($donor,['route' => ['fieldcoordinator.donors.update',$domain,$donor->id],'method' => 'PUT','class' => 'form-horizontal push-10-t push-10','id' => 'change-donor-details-form']) !!}
                ...
                <div class="col-md-5 col-xs-12">
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">{{$donor->fullname}}</h3>
                        </div>
                        <div class="block-content">
                            <div class="row">
                                <div class="col-xs-12">
                ...
                <div class="col-md-7 col-xs-12">
                    <div class="block">
                        ...
                        <div class="block-content">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach($donor->donations()->paginate(5) as $donation)
                                                <tr>
                                                    <td><a href="{{ route('fieldcoordinator.donations.show',[$domain,$donation->id]) }}">{{ $donation->promised_amount }} Rs</a></td>
                            ...
                            @else
                                <div class="alert alert-warning">There are no donations associated with this donor, we suggest you instruct the teamleaders to add one.</div>
                            @endif  
                        </div>
                    </div>
                </div>
