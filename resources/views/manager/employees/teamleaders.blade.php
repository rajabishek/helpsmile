    ...
    <main id="main-container">
        ...
        <div class="content bg-gray-lighter">
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">Teamleaders performance</h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Manage</li>
                        <li><a class="link-effect" href="">Teamleaders</a></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <a class="block block-link-hover3" href="javascript:void(0)">
                            <div class="block-content block-content-full text-center">
                                <div>
                                    <img class="img-avatar img-avatar96" src="{{ $teamleader->photocss }}" alt="">
                                </div>
                                <div class="h5 push-15-t push-5">{{ str_limit($teamleader->fullname, 21, $end = '..')}}</div>
                            </div>
