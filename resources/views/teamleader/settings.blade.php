...
<div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
    ...
    <main id="main-container">
        ...
        <div class="content">
            ...
            @include('partials._changepassword',['changePasswordPostRoute' => 'teamleader.settings.changePassword'])
            <!-- END Password Change Modal -->
			
            <!-- Settings and Profile Upload Form -->
			      @include('partials._settingsprofileupload',['changeProfilePostRoute' => 'teamleader.settings.changeProfile','settingsPostRoute' => 'teamleader.settings.store'])
