...
<!-- Notification 1  -->
<div style="display: none" id="element_040774300415068865"></div><!-- End Notification 1 -->

<!-- Notification 2  -->
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full"  bgcolor="#2a2a2a"style="background-color: rgb(42, 42, 42);">
	<tr>
		<td bgcolor="#2a2a2a"style="background-color: rgb(42, 42, 42);">
									...
									<table width="300" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
										<tr>
											<td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 22px; color: rgb(255, 255, 255); line-height: 32px; font-weight: 100;"class="fullCenter" >
												<!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;"><!--<![endif]-->Hi {{$user->fullname}}, here’s your<!--[if !mso]><!--></span><!--<![endif]--> 
			
			
			<!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgbold', Helvetica; font-weight: normal;"><!--<![endif]-->PASSWORD<!--[if !mso]><!--></span><!--<![endif]-->
											</td>
										</tr>
									</table>							
								</td>
			...
			<table width="392" border="0" cellpadding="0" cellspacing="0" align="center" class="full">
				<tr>
						...
						<table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="full" style="border-top-right-radius: 5px; border-top-left-radius: 5px;">
							<tr>
								<td align="center" width="352" valign="middle" bgcolor="#22a7f0" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px;">
									...
									<table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#e85140" style="border-top-right-radius: 5px; border-top-left-radius: 5px; background-color: rgb(92, 144, 210);"object="drag-module-small">
										<tr>
											<td align="center" width="352" valign="middle">
									...
									<table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#e85140"object="drag-module-small" style="background-color: rgb(92, 144, 210);">
										<tr>
												...
												<table width="265" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
													<tr>
														<td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 15px; color: rgb(255, 255, 255); line-height: 24px;"class="fullCenter" >
															<!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;"><!--<![endif]-->You (or someone else) has requested the password recovery of your Helpsmile account. If this sounds familiar, go ahead and follow the recovery link below. Otherwise, you may ignore this email. The link will expire automatically in {{ Config::get('auth.reminder.expire', 60) }} minutes. <!--[if !mso]><!--></span><!--<![endif]-->
														</td>
													</tr>
												</table>							
											</td>
																...
																<tr> 
																	<td align="center" height="45"bgcolor="#ffffff" style="border-top-left-radius: 5px; border-top-right-radius: 5px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; padding-left: 30px; padding-right: 30px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; color: rgb(42, 42, 42); text-transform: uppercase; background-color: rgb(255, 255, 255);">
																		<!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgbold', Helvetica; font-weight: normal;"><!--<![endif]-->
																			<a href="{{ url('password/reset', array($token)) }}" style="color: rgb(42, 42, 42); font-size: 15px; text-decoration: none; line-height: 34px; width: 100%;">Change password</a>
																		<!--[if !mso]><!--></span><!--<![endif]-->
																	</td> 
																</tr> 
															</table> 
									...
									<table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#e85140"object="drag-module-small" style="background-color: rgb(92, 144, 210);">
										<tr>
											<td align="center" width="352" valign="middle">
												...
												<table width="265" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
													<tr>
														<td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(255, 255, 255); line-height: 24px;"class="fullCenter" >
															<span ><!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;"><!--<![endif]-->or do something else<!--[if !mso]><!--></span><!--<![endif]--></span> 
															<!--[if !mso]><!--><span style="font-family: 'proxima_novasemibold', Helvetica; font-weight: normal;"><!--<![endif]--><a href="{{ route('auth.getLogin',$user->organisation->domain) }}"  style="color: rgb(255, 255, 255);">here</a><!--[if !mso]><!--></span><!--<![endif]-->
														</td>
													</tr>
												</table>							
											</td>
									...
									<table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#e85140"style="border-bottom-left-radius: 5px; border-bottom-right-radius: 5px; background-color: rgb(92, 144, 210);" object="drag-module-small">
										<tr>
											<td align="center" width="352" valign="middle">
					...
					<td align="center" width="20" valign="middle" bgcolor="#2a2a2a"></td>
				</tr>
			</table>
...
<!-- Notification 3 -->
<div style="display: none" id="element_08801515453960747"></div><!-- End Notification 3 -->

<!-- Notification 4  -->
<div style="display: none" id="element_021636921958997846"></div><!-- End Notification 4 -->

<!-- Notification 5 -->
<div style="display: none" id="element_014803599403239787"></div><!-- End Notification 5 -->

<!-- Notification 6 -->
<div style="display: none" id="element_08976250828709453"></div><!-- End Notification 6 -->
</div>
